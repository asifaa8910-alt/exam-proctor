...
import { UserPlus, Trash2, Mail, User, BookOpen } from 'lucide-react';
...
export default function ManageStudents() {
    ...
    const handleAssign = () => {
        selectedExams.forEach(examId => {
            assignExamToStudents(examId, [assignStudentId]);
        });
                                ...
                                <tr key={s.id}>
                                    ...
                                    <td>
                                        <div style={{ display: 'flex', gap: 8 }}>
                                            ...
                                            <button className="btn btn-danger btn-sm" onClick={() => removeStudent(s.id)} style={{ padding: '6px 8px' }}>
                                                <Trash2 size={13} />
                                            </button>
                                        </div>
                                    </td>
