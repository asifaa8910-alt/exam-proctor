...
import {
    FileText, Users, ClipboardCheck, AlertTriangle, Clock, BarChart3,
    ChevronDown, ChevronUp, Eye, Award, BookOpen, Calendar, CheckCircle,
    TrendingUp, UserX, Play
} from 'lucide-react';
    ...
    return (
        <div className="page-container">
            <div className="page-header">
                ...
                <p>Overview of your examination system</p>
            </div>
            ...
            {expandedSection === 'exams' && (
                <div className="card" style={{ marginBottom: 24, animation: 'scaleIn 0.2s ease' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                        <h3 style={{ fontSize: '1rem' }}>📚 All Exams</h3>
                        <button className="btn btn-primary btn-sm" onClick={() => navigate('/admin/create-exam')}>
                            + Create New
                        </button>
                    </div>
                                    ...
                                    {expandedExam === exam.id && (
                                        <div style={{
                                            ...
                                            <div style={{ display: 'flex', gap: 8 }}>
                                                <button className="btn btn-secondary btn-sm" onClick={() => navigate('/admin/grade')}>
            ...
            {expandedSection === 'students' && (
                <div className="card" style={{ marginBottom: 24, animation: 'scaleIn 0.2s ease' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                        <h3 style={{ fontSize: '1rem' }}>👥 Registered Students</h3>
                        <button className="btn btn-primary btn-sm" onClick={() => navigate('/admin/students')}>Manage All</button>
                    </div>
            ...
            {expandedSection === 'grading' && (
                <div className="card" style={{ marginBottom: 24, animation: 'scaleIn 0.2s ease' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                        ...
                        <button className="btn btn-primary btn-sm" onClick={() => navigate('/admin/grade')}>Grade Now</button>
                    </div>
            ...
            {expandedSection === 'flagged' && (
                <div className="card" style={{ marginBottom: 24, animation: 'scaleIn 0.2s ease' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                        ...
                        <button className="btn btn-secondary btn-sm" onClick={() => navigate('/admin/logs')}>View Logs</button>
                    </div>
